...
var OpenCageLocation = function (_BaseLocation) {
  _inherits(OpenCageLocation, _BaseLocation);

  function OpenCageLocation(config) {
    _classCallCheck(this, OpenCageLocation);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(OpenCageLocation).call(this, config));

    _this.setProvider((0, _nodeGeocoder2.default)('opencage', 'http', _this.get()));
    return _this;
  }
  ...
  return OpenCageLocation;
}(_BaseLocation3.default);

exports.default = OpenCageLocation;
