...
var FreeGeoIpLocation = function (_BaseLocation) {
  _inherits(FreeGeoIpLocation, _BaseLocation);

  function FreeGeoIpLocation(config) {
    _classCallCheck(this, FreeGeoIpLocation);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(FreeGeoIpLocation).call(this, config));

    _this.setProvider((0, _nodeGeocoder2.default)('freegeoip', 'http', _this.get()));
    return _this;
  }
  ...
  _createClass(FreeGeoIpLocation, [{
    key: 'geocode',
  ...
  return FreeGeoIpLocation;
}(_BaseLocation3.default);

exports.default = FreeGeoIpLocation;
