...
var AgolLocation = function (_BaseLocation) {
  _inherits(AgolLocation, _BaseLocation);

  function AgolLocation(config) {
    _classCallCheck(this, AgolLocation);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AgolLocation).call(this, config));

    _this.setProvider((0, _nodeGeocoder2.default)('agol', 'https', _this.get()));
    return _this;
  }
