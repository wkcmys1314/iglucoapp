...
var HereLocation = function (_BaseLocation) {
  _inherits(HereLocation, _BaseLocation);

  function HereLocation(config) {
    _classCallCheck(this, HereLocation);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(HereLocation).call(this, config));

    _this.setProvider((0, _nodeGeocoder2.default)('here', 'http', _this.get()));
    return _this;
  }
