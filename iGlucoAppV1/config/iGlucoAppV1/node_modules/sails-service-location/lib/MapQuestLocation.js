...
var MapQuestLocation = function (_BaseLocation) {
  _inherits(MapQuestLocation, _BaseLocation);

  function MapQuestLocation(config) {
    _classCallCheck(this, MapQuestLocation);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MapQuestLocation).call(this, config));

    _this.setProvider((0, _nodeGeocoder2.default)('mapquest', 'http', _this.get()));
    return _this;
  }
