...
var TomTomLocation = function (_BaseLocation) {
  _inherits(TomTomLocation, _BaseLocation);

  function TomTomLocation(config) {
    _classCallCheck(this, TomTomLocation);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TomTomLocation).call(this, config));

    _this.setProvider((0, _nodeGeocoder2.default)('tomtom', 'http', _this.get()));
    return _this;
  }
  ...
  return TomTomLocation;
}(_BaseLocation3.default);

exports.default = TomTomLocation;
