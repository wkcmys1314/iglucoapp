...
var OpenStreetMapLocation = function (_BaseLocation) {
  _inherits(OpenStreetMapLocation, _BaseLocation);

  function OpenStreetMapLocation(config) {
    _classCallCheck(this, OpenStreetMapLocation);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(OpenStreetMapLocation).call(this, config));

    _this.setProvider((0, _nodeGeocoder2.default)('openstreetmap', 'http', _this.get()));
    return _this;
  }
  ...
  _createClass(OpenStreetMapLocation, [{
    key: 'geocode',
...
exports.default = OpenStreetMapLocation;
