...
var YandexLocation = function (_BaseLocation) {
  _inherits(YandexLocation, _BaseLocation);

  function YandexLocation(config) {
    _classCallCheck(this, YandexLocation);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(YandexLocation).call(this, config));

    _this.setProvider((0, _nodeGeocoder2.default)('yandex', 'http', _this.get()));
    return _this;
  }
...
exports.default = YandexLocation;
