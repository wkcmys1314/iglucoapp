...
var GoogleLocation = function (_BaseLocation) {
  _inherits(GoogleLocation, _BaseLocation);

  function GoogleLocation(config) {
    _classCallCheck(this, GoogleLocation);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(GoogleLocation).call(this, config));

    _this.setProvider((0, _nodeGeocoder2.default)('google', _this.get('apiKey') ? 'https' : 'http', _this.get()));
    return _this;
  }
...
exports.default = GoogleLocation;
